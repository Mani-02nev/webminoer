...
import { CheckCircle2, Loader2, Star, Send, XCircle } from 'lucide-react';
...
const AttendancePage = () => {
    ...
    const [checkingWebinar, setCheckingWebinar] = useState(true);
    ...
    useEffect(() => {
        const fetchActiveWebinar = async () => {
            try {
                ...
                // No active webinar — attendance closed
            } finally {
                setCheckingWebinar(false);
            }
        };
        fetchActiveWebinar();
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Check if already submitted for this webinar
            let query = supabase
                .from('attendance')
                .select('id')
    ...
    if (checkingWebinar) {
        return (
            <div className="min-h-screen pt-32 pb-20 bg-dark-bg flex items-center justify-center">
        ...
        return (
            <div className="min-h-screen pt-32 pb-20 bg-dark-bg flex items-center justify-center relative overflow-hidden px-6">
                <div className="card-glass p-10 max-w-md w-full text-center">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-2">Attendance Closed</h2>
                    <p className="text-gray-400 mb-6">
                        Attendance is currently not open for any webinar. Please check back later or contact the organiser.
                    </p>
        ...
        <div className="min-h-screen pt-32 pb-20 bg-dark-bg relative overflow-hidden px-6">
            <div className="layout-container max-w-2xl">
                <div className="text-center mb-10">
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 text-sm font-medium">
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit" disabled={loading} className="btn-primary w-full h-14 text-lg flex items-center justify-center gap-2">
